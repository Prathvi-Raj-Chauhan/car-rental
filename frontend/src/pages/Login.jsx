    ...
    <div className="bg-page min-h-[60vh] flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-xl shadow-card border border-slate-200/80 p-6 md:p-8">
          <h1 className="text-2xl font-semibold text-jet-black mb-6">Login</h1>
          ...
          <p className="mt-6 text-center text-slate-600 text-sm">
            Don't have an account? <Link to="/register" className="text-burnt-peach font-medium hover:underline">Register</Link>
            {' · '}
            <Link to="/driver/register" className="text-burnt-peach font-medium hover:underline">Register as driver</Link>
          </p>
        </div>
      </div>
    </div>
